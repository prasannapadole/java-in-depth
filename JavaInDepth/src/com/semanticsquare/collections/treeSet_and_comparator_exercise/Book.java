...
class Book implements Comparable {
	...
	static final Comparator<Book> TITLE_COMPARATOR = new Comparator<Book>() {
	...
	static class PubDateComparators {
		static class PubDateAscComparator implements Comparator<Book>{
		...
		static class PubDateDescComparator implements Comparator<Book> {
